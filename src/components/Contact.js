...
const Contact = () => {
  ...
  const onSubmit = (e) => {
    ...
    if (
      ...
      emailjs
        .send(
          "service_d5byo0h", // service id
          "template_pilpn2g", // template id
          mailData,
          "OrTshzZFgLRMDcve5" // public api
        )
        .then(
          (response) => {
            setError(false);
  ...
  console.log(error);
  return (
    <section id="contactme" className="section gray-bg">
